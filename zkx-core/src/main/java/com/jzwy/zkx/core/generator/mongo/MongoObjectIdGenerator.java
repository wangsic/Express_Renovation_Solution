package com.jzwy.zkx.core.generator.mongo;
 ...
 * MongoDB Object ID
 */
public class MongoObjectIdGenerator implements IdentityGenerator, SequenceGenerator {
     ...
     */
    public static class ObjectId implements Comparable<ObjectId>, Serializable {
        ...
        public ObjectId(final ByteBuffer buffer) {
            ...
            Guard.isTrue(buffer.remaining() >= 12, "buffer.remaining() >=12");
